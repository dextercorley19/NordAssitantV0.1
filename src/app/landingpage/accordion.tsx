...
const AccordionComponent = () => {
  return (
    <div className="mx-auto my-32 max-w-5xl">
      ...
      <Accordion type="single" collapsible>
        <AccordionItem value="item-1">
          <AccordionTrigger>What are some things Nord could help me with?</AccordionTrigger>
          <AccordionContent>
            Answer goes here.
          </AccordionContent>
        </AccordionItem>
      ...
      <Accordion type="single" collapsible>
        <AccordionItem value="item-1">
          <AccordionTrigger>What are the features planned for Nord?</AccordionTrigger>
          <AccordionContent>
            Answer goes here.
          </AccordionContent>
        </AccordionItem>
