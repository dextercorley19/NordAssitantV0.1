    ...
    <>
      <div className="mx-auto mb-28 mt-36 flex max-w-4xl justify-center">
        <div className="rounded-lg bg-white px-8 py-6 shadow-md">
          ...
          <h3 className="mt-4 text-lg font-bold">Interpretation</h3>
          <p>
          ...
          <h3 className="mt-4 text-lg font-bold">Definitions</h3>
          ...
          <ul className="ml-6 list-disc">
            ...
            <li>
              <p>
                ...
                or &quot;Our&quot; in this Agreement) refers to NordAssistant,
                4539 138th ave se.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong className="font-bold">Service Provider</strong> means
            ...
            <li>
              <p>
                <strong className="font-bold">Website</strong> refers to Nord
                Assistant, accessible from{" "}
                <Link
                  href="http://www.nordassistant.com"
          ...
          <h3 className="mt-4 text-lg font-bold">Types of Data Collected</h3>
          <h4>Personal Data</h4>
          <p>
          ...
          <ul className="ml-6 list-disc">
            <li>
              <strong className="font-bold">Cookies or Browser Cookies.</strong>{" "}
            ...
            <li>
              <strong className="font-bold">Web Beacons.</strong> Certain
          ...
          <h3 className="mt-4 text-lg font-bold">Use of Your Personal Data</h3>
          ...
          <ul className="ml-6 list-disc">
            ...
            <li>
              <p>
                <strong className="font-bold">To manage Your Account:</strong>{" "}
            ...
            <li>
              <p>
                <strong className="font-bold">To provide You</strong> with news,
            ...
            <li>
              <p>
                <strong className="font-bold">To manage Your requests:</strong>{" "}
                To attend and manage Your requests to Us.
              </p>
            </li>
            <li>
              <p>
                <strong className="font-bold">For business transfers:</strong>{" "}
          ...
          <ul className="ml-6 list-disc">
            ...
            <li>
              <strong className="font-bold">For business transfers:</strong> We
            ...
            <li>
              <strong className="font-bold">With Affiliates:</strong> We may
            ...
            <li>
              <strong className="font-bold">With business partners:</strong> We
              may share Your information with Our business partners to offer You
              certain products, services or promotions.
            </li>
            <li>
              <strong className="font-bold">With other users:</strong> when You
            ...
            <li>
              <strong className="font-bold">With Your consent</strong>: We may
          ...
          <h3 className="mt-4 text-lg font-bold">Delete Your Personal Data</h3>
          <p>
          ...
          <h2 className="mt-4 text-lg font-bold">Children&apos;s Privacy</h2>
          <p>
          ...
          <h2 className="mt-4 text-lg font-bold">Links to Other Websites</h2>
          <p>
          ...
          <ul className="ml-6 list-disc">
            <li>
              ...
              <Link
                href="http://www.nordassistant.com/privacypolicy"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://www.nordassistant.com/privacypolicy
              </Link>
            </li>
          </ul>
        </div>
