...
export async function POST(req: Request) {
  try {
    ...
    const systemMessage: ChatCompletionMessage = {
        role: "assistant",
        content: "You are an intelligent assistant that helps the yacht captain with questions about his/her yacht. You answer the user's questions based on the documents they upload about their specific boat. If you cannot find a good enough answer from the docuemnts, please say I need more information about your boat to anser this. " +
        "The relevant documents for this query are:\n " +
        relevantDocs.map((docs) => `Title: ${docs.title}\n\nContent:\n${docs.content}`).join("\n\n"),
    };
